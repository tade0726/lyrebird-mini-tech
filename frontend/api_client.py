...
class APIClient:
    ...
    def send_audio_to_dictation(self, audio_data: bytes, file_extension: str = ".wav") -> Dict[str, Any]:
        ...
        try:
            ...
            with open(temp_file_path, "rb") as audio_file:
                ...
                response = requests.post(config.dictation_endpoint, headers=headers, files=files)
    ...
    def submit_edit(self, original_text: str, edited_text: str) -> Optional[Dict[str, Any]]:
